...
async_bo <- read_csv("/data/async/async_bo.csv")
async_parh <- read_csv("/data/async/async_parh.csv")
...
sync_bo <- read_csv("/data/sync/sync_bo.csv")
sync_parh <- read_csv("/data/sync/sync_parh.csv")
...
# removing pilots, people who correctly identified the hypothesis (manual check), people who are knowledgeable about the procedure, and failure of attention checks
async_af_bo <- read_csv("/data/within/async_af_bo.csv")
...
sync_af_bo <- read_csv("/data/within/sync_af_bo.csv")
...
async_sf_bo <- read_csv("/data/within/async_sf_bo.csv")
...
sync_sf_bo <- read_csv("/data/within/sync_sf_bo.csv")
...
parh_within <- read_csv("/data/within/parh.csv")
...
write.csv(df, "/data/gorilla_combined.csv")
```
...
pdf("/figures/bo_ci.pdf", width = 4, height = 3)
